<template>
  ...
  <el-drawer title="机构信息修改" 
  size="30%" 
  :visible.sync="dialogVisible" 
  :modal-append-to-body="false"
  style="height:100%;"
  >
    <sys-info-form ref="editform" v-bind:editable="true" :data="info" :loading="showLoading"
...
<script>
  ...
  import SysInfoForm from './SysInfoForm'

  export default {
    name: 'SysInfoEditDrawer',
    components: {SysInfoForm},
    data () {
      return {
        info: {},
        dialogVisible: false,
