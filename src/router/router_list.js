...
const mpalist=
    {
        ...
        'AdminIndex': () => import('@/views/Home.vue'),
        'UserManagement': () => import('@/views/Users.vue'),
        'RoleManagement': () => import('@/views/Roles/RolesManageIndex.vue'),
        'MenuManagement': () => import('@/views/Menus/MenusManageIndex.vue'),
        'PermManagement': () => import('@/views/Perms/PermsManageIndex.vue'),
